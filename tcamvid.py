...
def train(res_savepath=None):
    ...
    dist.init_process_group(
                backend = 'nccl',
                init_method = 'tcp://127.0.0.1:33999',
    ...
    ds = Camvid('/home/lyf/git-repo/BiSeNet/camvid', cropsize=cropsize, mode='train')
    ...
    save_pth = osp.join(res_savepath, 'model_final_nn2.pth')
    #net.cpu()
