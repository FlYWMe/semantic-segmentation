...
class GlobalContext(nn.Module):
    def __init__(self, inc, outc, *args, **kwargs):
        ...
        self.pre = ConvBnRelu(inc, outc, 1, 1, 0)
        self.se_channel_att = CBAM(outc)
    ...
    def forward(self, x):
        ...
        glob = out + last
        se_glob = self.pre(glob)
        se_glob = self.se_channel_att(se_glob)#.expand_as(glob)
