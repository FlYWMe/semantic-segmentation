...
class MscEval(object):
    ...
    def evaluate(self):
        ...
        for i, (imgs, label,fn) in enumerate(dloader):
            ...
            #     for i in range(newlabel.shape[1]):
            #         for j in range(newlabel.shape[2]):
...
def evaluate(respth='./res1024', dspth='/home/lyf/git-repo/real-time-segmentation/datasets/cityscapes/cityscapes',e='final', istest=0):
    ## logger
    ...
    scope(net, input_size=(3, 780, 780))
    # compute_speed(net,(1,3,780,780), 0, 1000) 
    net.cuda()
    net.eval()
...
if __name__ == "__main__":
    ...
    evaluate(respath, e=args.epochs,istest=0)
